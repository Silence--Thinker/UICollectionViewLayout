...
#import "XJFirstViewController.h"

#import "XJCollectionViewCell.h"
#import "XJFirstCollectionViewLayout.h"

@interface XJFirstViewController () <UICollectionViewDelegate, UICollectionViewDataSource>
...
@implementation XJFirstViewController
...
- (UICollectionView *)collectionView {
    if (!_collectionView) {
        XJFirstCollectionViewLayout *layout = [[XJFirstCollectionViewLayout alloc] init];
